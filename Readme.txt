...
Update-Database -Context Movie_Booking_IdentityContext



5. On the console execute the following command

 Update-Database -Context Movie_Booking_DataContext 



6. After migration is successful Run the project 

7 if you click on Bookings/Movies etc (Except Home) will redirect you to ASP .net identity login page login from the following credentials

User : admin@mvbookings.com
Password: 1qaz2wsX@
